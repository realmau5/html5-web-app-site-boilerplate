    ...
    function Booklet(inTarget, inOptions) {
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            updateOptions = function (newOptions) {
                ...
                // add click actions and checking the cookies
                ctrlsN.on('click.booklet', function (e) {
                    e.preventDefault();
                    $( ".b-next" ).removeClass("b-next-disabled");
                    //Register popup init
                    if ($(".b-page-6").hasClass('b-p1') || $(".b-page-18").hasClass('b-p1') || $(".b-page-34").hasClass('b-p1') || $(".b-page-48").hasClass('b-p1') || $(".b-page-68").hasClass('b-p1') || ($(".b-page-80").hasClass('b-p1')) || ($(".b-page-110").hasClass('b-p1')) || ($(".b-page-134").hasClass('b-p1'))) {
                                console.log('checking the register popup');
                                if (document.cookie.indexOf("registered=") >= 0) {
                                    console.log("Already registered");
                                    next();
                                } else {
                                    $('.oracleiframe').trigger('click');
                                    // cookieVisited();
                                    // $('#server_msg_modal').addClass('in').show();
                                    // $('body').append('<div class="modal-backdrop fade in"></div>');
                                    // $('#server_msg_modal').on('hide.bs.modal', function(e) {
                                    //     e.preventDefault();
                                    // });
                                }
                            } if ($(".b-page-166").hasClass('b-p1')) {

                        $( ".b-next" ).addClass("b-next-disabled");
